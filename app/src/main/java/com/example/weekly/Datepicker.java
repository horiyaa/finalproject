...
public class Datepicker extends Fragment {
    ...
    private View datePickerFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        datePickerFragment = inflater.inflate(R.layout.fragment_datepicker, container, false);
        attachComponents();
    ...
    private void attachComponents(){
        text = datePickerFragment.findViewById(R.id.text);
        button = datePickerFragment.findViewById(R.id.button);
